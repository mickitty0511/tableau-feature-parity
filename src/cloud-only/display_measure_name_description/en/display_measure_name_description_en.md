...
Cloud version Measure Names description display:

![Cloud Measure Names description display](../jp/img/cloud/display_measure_name_description_cloud_jp.png)

### Tableau Desktop
Descriptions are not displayed in the context menu for Measure Names in Tableau Desktop.

Desktop version Measure Names (no description display):

![Desktop Measure Names](../jp/img/desktop/display_measure_name_description_desktop_jp.png)
