...
![Detailed Publish Options in Desktop](../jp/img/desktop/detailed_publish_options_desktop_jp.png)

### Tableau Cloud
1. When publishing a workbook, only a basic dialog is displayed
2. Detailed configuration options are not available

![Basic Publish Dialog in Cloud](../jp/img/cloud/basic_publish_dialog_cloud_jp.png)
