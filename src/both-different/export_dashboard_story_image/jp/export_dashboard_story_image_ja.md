...
![Desktop画像エクスポート1](./img/desktop/[ダッシュボード]イメージのエクスポート.png)
![Desktop画像エクスポート2](./img/desktop/[ストーリーの]イメージのエクスポート.png)
...
![Cloud画像エクスポート1](./img/cloud/[ビュー]イメージコマンド.png)
![Cloud画像エクスポート2](./img/cloud/[ワークブック編集画面]イメージコマンド.png)
