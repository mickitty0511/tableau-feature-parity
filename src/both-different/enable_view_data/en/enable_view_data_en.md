...
![Desktop worksheet blank context menu](../jp/img/desktop/enable_view_data_desktop_jp_2.png)

Method 2: From selected data
1. Select the data you want to display
2. Right-click and select "View Data" from the context menu
![Desktop selected data context menu](../jp/img/desktop/enable_view_data_desktop_jp.png)

Method 3: From data pane search area
1. Click the icon to the right of the search box in the data pane
![Desktop data pane search right side](../jp/img/desktop/enable_view_data_desktop_jp_4.png)

Method 4: From Data tab
1. Click the "Data" tab
2. Select the target data source and click "View Data"
![Desktop access from data menu](../jp/img/desktop/enable_view_data_desktop_jp_3.png)

Method 5: From data source context menu
1. Right-click on a data source name in the data pane
2. Select "View Data" from the context menu
![Desktop data source context menu](../jp/img/desktop/enable_view_data_desktop_jp_5.png)

Method 6: From Analytics tab
1. Click the "Analytics" tab
2. Click "View Data"
![Desktop access from Analytics tab](../jp/img/desktop/enable_view_data_desktop_jp_6.png)
...
![Cloud worksheet blank context menu](../jp/img/cloud/enable_view_data_cloud_jp_2.png)

Method 2: From selected data
1. Select the data you want to display
2. Right-click and select "View Data" from the context menu

![Cloud selected data context menu](../jp/img/cloud/enable_view_data_cloud_jp.png)
