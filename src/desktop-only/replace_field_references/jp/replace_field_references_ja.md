...
![Desktop メニュー例](./img/desktop/replace_field_references_desktop_jp.png)

3. 置換先のフィールドを選択します。
4. 置換が実行され、そのフィールドを使用している全ての計算フィールドとワークシートが自動的に更新されます。

![Desktop 機能デモ](./img/desktop/replace_field_references_demo_desktop_jp.gif)

### Tableau Cloud での制限

Tableau Cloud では、フィールドを右クリックしても「参照の置換」オプションは表示されません。基本的なコンテキストメニューのみが利用可能です。

![Cloud コンテキストメニュー例](./img/cloud/replace_field_references_cloud_jp.png)
