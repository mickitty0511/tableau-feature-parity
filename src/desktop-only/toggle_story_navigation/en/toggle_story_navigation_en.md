...
![Story Navigation Settings](../jp/img/desktop/story_navigation_options_desktop_jp.png)

4. When settings are applied, the button display state changes

![Story Navigation Demo](../jp/img/desktop/story_navigation_demo_desktop_jp.gif)

### Tableau Cloud
1. Open a story worksheet
2. Only basic story formatting options are available

![Basic Story Formatting](../jp/img/cloud/basic_story_formatting_cloud_jp.png)
