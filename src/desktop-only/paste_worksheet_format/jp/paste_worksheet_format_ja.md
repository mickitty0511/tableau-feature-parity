...
![書式設定メニュー](./img/desktop/paste_worksheet_format_menu_desktop_jp.png)

3. 書式設定を適用したいワークシートのタブを右クリックします。
4. 「書式設定の貼り付け」を選択します。

![書式設定のコピー・貼り付けのデモ](./img/desktop/paste_worksheet_format_demo_desktop_jp.gif)

5. 書式設定オプションダイアログが表示されます。適用したい書式設定項目を選択します。

![書式設定オプション](./img/desktop/paste_worksheet_format_options_desktop_jp.png)

### Tableau Cloud
Tableau Cloudでは、ワークシートタブの右クリックメニューに基本的なオプションのみが表示され、書式設定のコピー・貼り付け機能は利用できません。

![Cloudの基本メニュー](./img/cloud/paste_worksheet_format_cloud_jp.png)
