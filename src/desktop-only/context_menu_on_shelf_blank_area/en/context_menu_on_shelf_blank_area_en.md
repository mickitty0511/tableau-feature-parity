...
![Desktop Shelf Blank Area Context Menu](./img/desktop/shelf_context_menu_options_desktop_jp.png)

Shelf context menu demo:

![Desktop Shelf Context Menu Demo](./img/desktop/shelf_context_menu_demo_desktop_jp.gif)

### Tableau Cloud

![No Shelf Context Menu in Cloud](./img/cloud/no_shelf_context_menu_cloud_jp.gif)
