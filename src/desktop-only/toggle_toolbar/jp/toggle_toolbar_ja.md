## 機能差異
ツールバー表示の切り替え機能は、Tableau Desktopでのみ利用可能です。

- **Desktop**: ウィンドウメニューからツールバーの表示/非表示を切り替えることができます。
- **Cloud**: この機能は利用できません。

## 使用方法
### Tableau Desktopの場合
1. メニューバーの「ウィンドウ」タブをクリックします。
2. 表示オプションからツールバーの表示/非表示を選択できます。

![Desktop表示オプション](./img/desktop/toggle_toolbar_desktop_jp.png)
