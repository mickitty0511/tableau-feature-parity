...
![Default Properties Menu](../jp/img/desktop/set_field_default_properties_menu_desktop_jp.png)

3. Select the property you want to configure from the submenu (color, number format, comments, aggregation, etc.).

![Default Properties Submenu](../jp/img/desktop/set_field_default_properties_submenu_desktop_jp.png)

4. Set values in the detailed configuration screen for the selected property.

![Field Formatting Options](../jp/img/desktop/set_field_default_properties_formatting_desktop_jp.png)

### Tableau Cloud
1. Right-click on a field in the data pane.
2. Only basic context menus are displayed.

![Basic Field Context Menu](../jp/img/cloud/set_field_default_properties_basic_menu_cloud_jp.png)

3. Default properties menu is not available.

![No Default Properties Menu](../jp/img/cloud/set_field_default_properties_no_menu_cloud_jp.png)

4. Available formatting options are limited.

![Basic Formatting Options](../jp/img/cloud/set_field_default_properties_formatting_cloud_jp.png)
