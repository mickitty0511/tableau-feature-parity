...
![Fine Cell Size Adjustment in Desktop](./img/desktop/fine_cell_size_adjustment_desktop_jp.gif)

### Tableau Cloud
1. Select the cell you want to adjust in a worksheet or dashboard
2. Only basic size adjustment options are available

![Basic Cell Adjustment in Cloud](./img/cloud/basic_cell_adjustment_cloud_jp.gif)
