...
![Export Data Menu](./img/desktop/export_data_menu_desktop_jp.png)

*Select export data from the data source right-click menu*

![Export Options](./img/desktop/export_data_options_desktop_jp.png)
...
![Basic Data Source Menu](./img/cloud/basic_data_source_menu_cloud_jp.png)
