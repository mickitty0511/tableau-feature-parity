...
![Desktop Multi-select Example](../jp/img/desktop/select_multiple_pills_desktop_jp.gif)
...
![Cloud Single-select Example](../jp/img/cloud/select_multiple_pills_cloud_jp.gif)
