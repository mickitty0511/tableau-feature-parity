---
title: フィールドのデフォルトプロパティ（色、数値書式、コメント、文字列フィールドの図形、数値フィールドの集計と合計）
...
![デフォルトプロパティメニュー](./img/desktop/default_properties_menu_desktop_jp.png)

3. サブメニューから設定したいプロパティを選択します（色、数値書式、コメント、集計など）。

![デフォルトプロパティサブメニュー](./img/desktop/default_properties_submenu_desktop_jp.png)

4. 選択したプロパティの詳細設定画面で値を設定します。

![フィールド書式設定オプション](./img/desktop/field_formatting_options_desktop_jp.png)

### Tableau Cloud
1. データペインでフィールドを右クリックします。
2. 基本的なコンテキストメニューのみが表示されます。

![基本的なフィールドコンテキストメニュー](./img/cloud/basic_field_context_menu_cloud_jp.png)

3. デフォルトプロパティメニューは利用できません。

![デフォルトプロパティメニューなし](./img/cloud/no_default_properties_menu_cloud_jp.png)

4. 利用可能な書式設定オプションは限定的です。

![基本的な書式設定オプション](./img/cloud/basic_formatting_options_cloud_jp.png)
