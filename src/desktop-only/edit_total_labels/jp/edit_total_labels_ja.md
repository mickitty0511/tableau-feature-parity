...
![Desktop コンテキストメニュー](./img/desktop/edit_total_labels_context_menu_desktop_jp.png)

2. 軸の編集ダイアログが開き、合計・総合計の詳細な書式設定オプションにアクセスできます

![Desktop 合計書式設定オプション](./img/desktop/edit_total_labels_options_desktop_jp.png)
...
![Cloud 基本書式設定メニュー](./img/cloud/edit_total_labels_cloud_jp.png)
