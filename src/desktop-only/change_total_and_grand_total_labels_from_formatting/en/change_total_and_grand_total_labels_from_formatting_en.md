...
![Desktop Context Menu](./img/desktop/axis_formatting_context_menu_desktop_jp.png)

2. The axis editing dialog opens, providing access to detailed formatting options for totals and grand totals

![Desktop Total Formatting Options](./img/desktop/total_formatting_options_desktop_jp.png)
...
![Cloud Basic Formatting Menu](./img/cloud/basic_formatting_menu_cloud_jp.png)
