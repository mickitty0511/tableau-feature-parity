...
![Desktop Fix Default Map Zoom](../jp/img/desktop/fix_default_map_zoom_desktop_jp.gif)

### Tableau Cloud
Tableau Cloud does not support the fix default map zoom functionality.

![Cloud Cannot Fix Default Map Zoom](../jp/img/cloud/no_fix_default_map_zoom_cloud_jp.png)
