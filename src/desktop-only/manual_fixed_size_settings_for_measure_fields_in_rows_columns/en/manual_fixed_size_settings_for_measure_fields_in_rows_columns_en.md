...
![Basic Size Settings Screen](./img/desktop/manual_fixed_size_settings_desktop_jp.png)

3. You can select "Manual" or "Fixed" options.

![Column Width Settings Options](./img/desktop/column_width_settings_desktop_jp.png)

4. You can enter specific numerical values to adjust the size.

![Size Configuration Dialog](./img/desktop/size_configuration_dialog_desktop_jp.png)

### Tableau Cloud
Tableau Cloud only allows percentage-based size adjustments; manual/fixed size settings are not available.

![Size Settings in Cloud](./img/cloud/percentage_size_setting_cloud_jp.png)
