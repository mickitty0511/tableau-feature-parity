...
![Analytics Formatting Options in Desktop](../jp/img/desktop/set_default_analytics_format_desktop_jp.png)

### Tableau Cloud
1. Each element must be individually selected for formatting.
2. Only basic formatting menus are available.

![Basic Formatting Menu in Cloud](../jp/img/cloud/set_default_analytics_format_cloud_jp.png)
