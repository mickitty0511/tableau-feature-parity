...
![データのエクスポートメニュー](./img/desktop/export_data_source_desktop_jp.png)

*データソースの右クリックメニューからデータのエクスポートを選択*

![エクスポートオプション](./img/desktop/export_data_source_options_desktop_jp.png)
...
![基本的なデータソースメニュー](./img/cloud/export_data_source_cloud_jp.png)
