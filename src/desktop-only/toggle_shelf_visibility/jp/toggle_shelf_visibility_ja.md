...
![デスクトップ版のワークシート空白部分のコンテキストメニュー](./img/desktop/toggle_shelf_visibility_menu_desktop_jp.png)

ワークシートの表示切り替えのデモ：

![デスクトップ版のワークシート表示切り替えデモ](./img/desktop/toggle_shelf_visibility_demo_desktop_jp.gif)

### Tableau Cloud

![Cloud版ではワークシートのコンテキストメニューなし](./img/cloud/toggle_shelf_visibility_cloud_jp.gif)
