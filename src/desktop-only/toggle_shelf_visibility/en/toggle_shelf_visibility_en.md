...
![Desktop Worksheet Blank Area Context Menu](../jp/img/desktop/toggle_shelf_visibility_menu_desktop_jp.png)

Worksheet display toggle demo:

![Desktop Worksheet Toggle Demo](../jp/img/desktop/toggle_shelf_visibility_demo_desktop_jp.gif)

### Tableau Cloud

![No Worksheet Context Menu in Cloud](../jp/img/cloud/toggle_shelf_visibility_cloud_jp.gif)
