## 機能の違い
予測、クラスタリングなどの高度な分析機能は、Tableau Desktopでのみ利用可能です。

- **Desktop**: アナリティクスペーンで予測、クラスタリングなどの高度な分析機能が使用できます。
...
![Desktop アナリティクスペーン](./img/desktop/enable_advanced_analytics_desktop_jp.png)

### Tableau Cloud
1. ワークシートを開き、左側のペインで「アナリティクス」タブを選択します。
2. 利用可能な機能は以下の基本的なものに限定されます：

![Cloud アナリティクスペーン](./img/cloud/enable_advanced_analytics_cloud_jp.png)
